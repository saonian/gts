  ...
  <div class="outer" <?php echo !$include_headfoot ? 'style="padding:0"' : '';?>>
    ...
    <input type="hidden" name="body" value="<?php echo $body;?>" />
      ...
      <table align="center" class="table-1 a-left">
        <caption>
        <div class="f-left"><strong>激活任务</strong></div>
        </caption>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="consumed" value="<?php echo $task->consumed;?>" class="text-2"/></td>
          </tr>
          <tr>
            <th class="rowhead">预计开始</th>
            <td><input type="text" name="est_started_date" value="" class="text-2 datetime"/></td>
          </tr>
          <tr>
            <th class="rowhead">截止日期</th>
            <td><input type="text" name="deadline" value="" class="text-2 datetime"/></td>
          </tr>
          <tr>
